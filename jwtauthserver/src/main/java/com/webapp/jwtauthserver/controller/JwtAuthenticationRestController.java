package com.webapp.jwtauthserver.controller;
...
import com.webapp.jwtauthserver.security.JwtTokenUtil;
...
public class JwtAuthenticationRestController {
	...
	@SneakyThrows
	/**
	 * questo metodo permette di generare il token
	...
	@SneakyThrows
	/**
	 * questo metodo permette di refreshare il token quando sta per scadere 
	 * @param request
	 * @return
	 */
	...
	/*
	 * gestisce le eccezioni nel caso in cui l'utente non sia valido
	 */
